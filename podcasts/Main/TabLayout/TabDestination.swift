...
enum TabDestination: Hashable {
    ...
    func title() -> String {
        ...
        case .playlists:
            return FeatureFlag.playlistsRebranding.enabled ? L10n.playlists : L10n.filters
        case .discover:
    ...
    func icon() -> UIImage? {
        ...
        case .playlists:
            return UIImage(named: FeatureFlag.playlistsRebranding.enabled ? "playlists_tab" : "filters_tab")
        case .discover:
