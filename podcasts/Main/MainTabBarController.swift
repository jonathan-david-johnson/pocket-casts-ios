...
class MainTabBarController: UITabBarController, NavigationProtocol {
    ...
    private lazy var profileTabBarItem = UITabBarItem(title: TabDestination.profile.title(), image: TabDestination.profile.icon(), tag: 0)
